                    ...
                    <div className="mb-3">
                      <Form>
                        <Form.Group className="mb-3" controlId="Name">
                          ...
                          <Form.Control type="text" name="name" onChange={(e) => inputHandler(e)} placeholder="Enter Name" />
                        </Form.Group>
                        ...
                        >
                          ...
                          <Form.Control type="password" name="passwordConfirm" onChange={(e) => inputHandler(e)} placeholder="Password" />
                        </Form.Group>
                        <Form.Group
                          className="mb-3"
